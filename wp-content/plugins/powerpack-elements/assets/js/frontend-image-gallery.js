		...
		class ImageGalleryWidget extends elementorModules.frontend.handlers.Base {
			...
			bindEvents() {
				...
				if ( ! elementorFrontend.isEditMode() ) {
					if ( gallery.hasClass('pp-image-gallery-masonry') || gallery.hasClass('pp-image-gallery-filter-enabled') ) {
			...
			renderGalleryItems( cachedItems, cachedIds ) {
				...
				if ( cachedItems.length > 0 ) {
					...
					let lightboxSelector = '.pp-grid-item-wrap .pp-image-gallery-item-link[data-fancybox="' + galleryId + '"]';
