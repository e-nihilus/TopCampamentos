...
class Devices extends Powerpack_Widget {
	...
	protected function register_content_video_options_controls() {
		...
		$this->add_control(
			'modestbranding',
			[
				'label'                 => esc_html__( 'Modest Branding', 'powerpack' ),
				'description'           => esc_html__( 'Turn on this option to use a YouTube player that does not show a YouTube logo.', 'powerpack' ),
				'type'                  => Controls_Manager::SWITCHER,
				'condition'             => [
					'media_type'    => 'video',
					'video_source'  => 'youtube',
